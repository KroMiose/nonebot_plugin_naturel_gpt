...
## 🆙 新 NG 重构版本发布 [Nekro-Agent](https://github.com/KroMiose/nekro-agent)

这是一个全新的基于容器技术的自执行代理 AI 机器人，支持人设扮演、实时代码编写与执行、高可扩展性代理 AI，支持 Docker-Compose 一键部署，欢迎前往体验 -> [Nekro-Agent](https://github.com/KroMiose/nekro-agent)
